...
class PSOOptimizer:
    ...
    def optimize(self, model, particles, weights_to_repair,
        ...
        use_cached_eval : bool
            Whether to use cached open-loop evaluation
        frame_data_dict : dict
            Frame data for cached evaluation
        positive_frames, negative_frames : list
            Frame lists for cached evaluation
        threshold_good, threshold_bad : float
            Thresholds for cached evaluation
        fitness_type : str
        ...
        evaluate_fitness_openloop_fn : callable
            Function to evaluate fitness (open-loop cached)
