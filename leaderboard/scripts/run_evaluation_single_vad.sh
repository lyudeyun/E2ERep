...
TEAM_AGENT=Bench2DriveZoo/team_code/vad_b2d_agent.py
# TEAM_CONFIG=your_team_agent_ckpt.pth   # for TCP and ADMLP
TEAM_CONFIG=Bench2DriveZoo/adzoo/vad/configs/VAD/VAD_base_e2e_b2d.py+Bench2DriveZoo/ckpts/vad_b2d_base.pth # for UniAD and VAD
BASE_CHECKPOINT_ENDPOINT=vad_base_bench2drive220_eval
SAVE_PATH=./vad_base_bench2drive220/
